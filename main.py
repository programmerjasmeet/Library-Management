...
#     display book
#     lend book - who onces the book is not present
#     add book
#     return book
#
# jasmeet lib library = (listofbooks,library_name)
# dictionary (book - name of the person)
# create a main function  and run an  infinete while loop asking users for input
